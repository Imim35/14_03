module.exports = {
  ...
  rules: {
    ...
    "no-multi-spaces": 0,           // Disallow multiple spaces (no-multi-spaces)
    "comma-dangle": 0,              // require or disallow trailing commas (comma-dangle)
    "indent": 0,                    // Validate Indentation (indent)
